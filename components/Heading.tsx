...
const Anchor = ({ id, inView, children }) => {
	return (
		...
		>
			{inView && (
				<div className="absolute mt-[0.625rem] hidden w-[var(--width)] opacity-100 transition [--width:calc(2.625rem+0.5px+45%-min(50%,calc(theme(maxWidth.lg)+theme(spacing.8))))] group-focus:opacity-100 lg:left-[-0.75rem] lg:block xl:left-[-0.625rem] 2xl:left-[3.25rem] 2xl:[--width:theme(spacing.10)]">
