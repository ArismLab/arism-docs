...
import { Context, createContext, useContext, useEffect, useLayoutEffect, useRef } from "react"
...
export const useVisibleSections = (sectionStore) => {
	let setVisibleSections = useStore(sectionStore, (s: any) => s.setVisibleSections)
